    ...
    spec:
      ...
      - command:
        ...
        - mountPath: /data/tce.config.center
          name: volume-supervisor_agent-path-0
          readOnly: true
      dnsConfig:
        options:
