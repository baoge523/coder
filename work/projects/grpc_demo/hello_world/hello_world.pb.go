...
const file_hello_world_proto_rawDesc = "" +
	"\n" +
	"\x11hello_world.proto\x12\vhello_world\"\"\n" +
	...
	"\aGreeter\x12@\n" +
	"\bSayHello\x12\x19.hello_world.HelloRequest\x1a\x17.hello_world.HelloReply\"\x00B\x17Z\x15grpc_demo/hello_worldb\x06proto3"
